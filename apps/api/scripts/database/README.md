...
Đăng nhập thử máy chủ:**`demo@example.com` / `demo1234`**. Khuyến nghị hằng ngày vẫn **`npx prisma db push`** + **`npm run db:seed`**; SQL chỉ dùng khi bạn muốn thao tác trực tiếp với PostgreSQL.
